        ...
        GeometryReader{geo in
                ZStack{
                    ...
                    VStack{
                        ...
                        mainStatsView(height: 100, width: geo.size.width, hth: self.main.health, atk: self.main.attack, acc: self.main.accuracy, arm: self.main.armour, blk: self.main.block, rgn: self.main.regens)
